...
def index(request):
	...
	message = '''<html>
                    ...
                    <body>
                        <div class="container">
                            <form name="submit_form" id="submit_form" action="/register/showdata/" method="post">
...
def showdata (request):
    ...
    return HttpResponseRedirect('/register/select/')
    ...
    for row in Users.objects.raw('SELECT * FROM person'):
        ...
        user += '''
                <tr>
                    ...
                    <td>'''+row.gender+'''</td>
                    <td>'''+row.dateofB+'''</td>
                    <td><a href="/register/update/?id='''+str(row.id)+'''">Update</a></td>
                    <td><a href="/register/delete/?id='''+str(row.id)+'''">Delete</a></td>
                </tr>
                '''
...
def update(request):
    ...
    message = '''<html>
                    ...
                    <body>
                        <div class="container">
                            <form name="submit_form" id="submit_form" action="/register/doUpdate/" method="post">
